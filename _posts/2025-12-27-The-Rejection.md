...
Exactor discloses a system and method for inducing controlled, localized pain in human subjects by targeting specific anatomical regions. Specifically, Exactor teaches:
*identifying nerve‑rich regions of the body as “targets” for application of pain;
*applying stimuli at those target regions; and
*sparing or dampening sensation in surrounding regions to heighten the perceived intensity and contrast at the target site.
